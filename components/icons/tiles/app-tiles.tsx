...
export const AppTiles: Record<string, TileRenderer> = {
  ...
  procurement: ({ palette }) => (
    <>
      ...
      <path d="M 12 17 H 33 L 30 28 H 15 Z" fill="currentColor" />
      {/* Accent rim */}
  ...
  vendorManagement: ({ palette }) => (
    <>
      <TileBase palette={palette} />
      <rect x="8" y="14" width="10" height="17" rx="1.5" fill="currentColor" />
  ...
  storeOperations: ({ palette }) => (
    <>
      <TileBase palette={palette} />
      <rect x="8" y="18" width="24" height="14" rx="1.5" fill="currentColor" />
      ...
      <circle cx="21.3" cy="27" r="0.5" fill="currentColor" />
  ...
  inventoryManagement: ({ palette }) => (
    <>
      ...
      <rect x="8" y="20" width="12" height="11" rx="1.4" fill="currentColor" />
      <rect x="8" y="23.5" width="12" height="1" style={{ fill: palette.shadow }} opacity="0.25" />
      <rect x="22" y="20" width="10" height="11" rx="1.4" fill="currentColor" />
  ...
  operationPlan: ({ palette }) => (
    <>
      <TileBase palette={palette} />
      <path d="M 11 18 C 8 17 8 11 13 11 C 13 8 17 7 20 9 C 23 7 27 8 27 11 C 32 11 32 17 29 18 Z" fill="currentColor" />
  ...
  report: ({ palette }) => (
    <>
      <TileBase palette={palette} />
      <path d="M 11 8 H 24 L 30 14 V 32 H 11 Z" fill="currentColor" />
  ...
  config: ({ palette }) => (
    <>
      ...
      <g transform="translate(20 20)">
        <rect x="-3" y="-15" width="6" height="30" rx="1.5" fill="currentColor" />
        <rect x="-3" y="-15" width="6" height="30" rx="1.5" fill="currentColor" transform="rotate(60)" />
        <rect x="-3" y="-15" width="6" height="30" rx="1.5" fill="currentColor" transform="rotate(120)" />
        <circle r="9.5" fill="currentColor" />
