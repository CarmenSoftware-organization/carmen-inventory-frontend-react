...
export const AppTiles: Record<string, TileRenderer> = {
  ...
  storeOperations: ({ palette }) => (
    <>
      ...
      <path
        d="M 14 12 V 18 M 20 12 V 18 M 26 12 V 18"
  ...
  operationPlan: ({ palette }) => (
    <>
      <TileBase palette={palette} />
      <path
        d="M 11 18 C 8 17 8 11 13 11 C 13 8 17 7 20 9 C 23 7 27 8 27 11 C 32 11 32 17 29 18 Z"
        fill="currentColor"
      />
      <rect
        x="11"
  ...
  accounting: ({ palette }) => (
    <>
      ...
      />
      <path
        d="M 20 19 V 29 M 12 22 H 28 M 12 26 H 28"
