...
export function ClaudeIcon({ className }: { readonly className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="#D97757"
...
export function DeepseekIcon({ className }: { readonly className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="#4D6BFE"
...
export function GrokIcon({ className }: { readonly className?: string }) {
  return (
    <svg
