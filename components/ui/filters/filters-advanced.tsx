...
import { FilterFieldPicker } from "@/components/ui/filters/filters-builder"
import {
...
} from "@/components/ui/filters/filters-chip"
import {
  filterControlSizes,
  filterReadOnlyProps,
...
import {
  FILTER_ROW_SELECTOR,
  useFilterRowDrag,
} from "@/components/ui/filters/filters-dnd"
import { filterIssueLabel } from "@/components/ui/filters/filters-i18n"
import {
...
import {
  ...
  getFilterOperator,
  operatorTakesValue,
} from "@/components/ui/filters/filters-operators"
import {
  collectFilterIssues,
  createFilterRule,
  isFilterRule,
...
import type {
  ...
  FilterQuery,
  FilterRule,
} from "@/components/ui/filters/filters-types"
    ...
    >
      ...
      <div className={CONTENT_BAND_CLASS}>
        <div className={cn(CELL_BOX_CLASS, FIELD_CELL_CLASS)}>
          ...
          >
            <PopoverTrigger asChild disabled={actions.disabled}>
              <Button
                variant="outline"
                size={sizes.button}
                {...filterReadOnlyProps(actions)}
      ...
      <div className={ACTION_BAND_CLASS}>
        ...
        >
          <DropdownMenuTrigger asChild disabled={actions.disabled}>
            <Button
              variant="ghost"
              size={sizes.icon}
              {...filterReadOnlyProps(actions)}
