...
Multi-agent workflow review of the entire Vite + React Router SPA (~168k LOC, ~1,150 files). 17 zones reviewed in parallel; every medium+ finding was adversarially verified by 3 skeptic lenses (correctness / security / reproducibility) — a finding is *confirmed* only when ≥2 of 3 skeptics failed to refute it.
...
- **routes-dashboard:** the workflow agent failed (API Overloaded, then monthly spend limit on resume); reviewed inline instead — no confirmed bugs, only minor notes (optimistic widget reorder does not roll back on a failed PATCH; `inferWidgetTypeFromShape` has a dead `"bar"` branch). See Low-severity notes.
...
| routes-dashboard | reviewed-inline | 0 | 0 | 0 | 2 |
| routes-report | reviewed | 13 | 3 | 1 | 9 |
| config-build | reviewed | 9 | 2 | 0 | 7 |

## Confirmed findings

Status legend: `pending` → updated to `fixed` / `backlog` / `wont-fix` after the fix phase.

### 1. [HIGH/correctness] `components/ui/comment-sheet.tsx:149`
*zone: components-ui · effort: medium · confidence: 0.8 · status: pending*
...
### 2. [HIGH/security] `hooks/use-logout.ts:17`
*zone: hooks · effort: quick-win · confidence: 0.85 · status: pending*
...
### 3. [HIGH/correctness] `hooks/use-thai-address.ts:31`
*zone: hooks · effort: quick-win · confidence: 0.9 · status: pending*
...
### 4. [HIGH/correctness] `routes/inventory-management/_shared/entry-notes-dialog.tsx:388`
*zone: routes-inventory · effort: medium · confidence: 0.55 · status: pending*
...
### 5. [HIGH/correctness] `routes/operation-plan/equipment/_components/eq-form.tsx:121`
*zone: routes-operation-plan · effort: quick-win · confidence: 0.7 · status: pending*
...
### 6. [HIGH/correctness] `routes/procurement/purchase-order/from-price-list/_components/step-select-items.tsx:164`
*zone: routes-procurement-a · effort: medium · confidence: 0.6 · status: pending*
...
### 7. [HIGH/correctness] `routes/procurement/approval/_components/approval-component.tsx:74`
*zone: routes-procurement-b · effort: medium · confidence: 0.8 · status: pending*
...
### 8. [HIGH/correctness] `routes/product-management/category/_components/category-form.tsx:94`
*zone: routes-product · effort: quick-win · confidence: 0.7 · status: pending*
...
### 9. [HIGH/correctness] `routes/external/pl/_components/price-list-external-component.tsx:108`
*zone: routes-report · effort: medium · confidence: 0.8 · status: pending*
...
### 10. [HIGH/correctness] `routes/system-admin/role/_components/role-component.tsx:56`
*zone: routes-system-admin · effort: quick-win · confidence: 0.85 · status: pending*
...
### 11. [HIGH/correctness] `routes/vendor-management/vendor/_components/vendor-address.tsx:144`
*zone: routes-vendor · effort: quick-win · confidence: 0.9 · status: pending*
...
### 12. [HIGH/correctness] `routes/vendor-management/request-price-list/_components/rfp-form.tsx:223`
*zone: routes-vendor · effort: quick-win · confidence: 0.7 · status: pending*
...
### 13. [MEDIUM/correctness] `components/navbar/notification.tsx:313`
*zone: components-app · effort: quick-win · confidence: 0.9 · status: pending*
...
### 14. [MEDIUM/correctness] `components/navbar/path-breadcrumb.tsx:94`
*zone: components-app · effort: quick-win · confidence: 0.85 · status: pending*
...
### 15. [MEDIUM/correctness] `components/keyboard-shortcuts-dialog.tsx:20`
*zone: components-app · effort: medium · confidence: 0.85 · status: pending*
...
### 16. [MEDIUM/correctness] `components/i18n-provider.tsx:45`
*zone: components-app · effort: quick-win · confidence: 0.7 · status: pending*
...
### 17. [MEDIUM/correctness] `components/ui/comment-sheet.tsx:334`
*zone: components-ui · effort: quick-win · confidence: 0.7 · status: pending*
...
### 18. [MEDIUM/correctness] `components/ui/tree-product-lookup.tsx:119`
*zone: components-ui · effort: medium · confidence: 0.65 · status: pending*
...
### 19. [MEDIUM/security] `package.json:48`
*zone: config-build · effort: quick-win · confidence: 0.85 · status: pending*
...
### 20. [MEDIUM/correctness] `scripts/deploy-s3.sh:24`
*zone: config-build · effort: medium · confidence: 0.8 · status: pending*
...
### 21. [MEDIUM/correctness] `hooks/use-exchange-rate.ts:134`
*zone: hooks · effort: quick-win · confidence: 0.85 · status: pending*
...
### 22. [MEDIUM/correctness] `hooks/use-navigation-guard.ts:70`
*zone: hooks · effort: medium · confidence: 0.7 · status: pending*
...
### 23. [MEDIUM/correctness] `lib/http-client.ts:224`
*zone: infra · effort: quick-win · confidence: 0.7 · status: pending*
...
### 24. [MEDIUM/correctness] `lib/safe-storage.ts:10`
*zone: infra · effort: quick-win · confidence: 0.6 · status: pending*
...
### 25. [MEDIUM/correctness] `lib/date-utils.ts:131`
*zone: infra · effort: quick-win · confidence: 0.55 · status: pending*
...
### 26. [MEDIUM/correctness] `routes/config/currency/_components/currency-dialog.tsx:272`
*zone: routes-config · effort: quick-win · confidence: 0.85 · status: pending*
...
### 27. [MEDIUM/correctness] `routes/config/location/_components/location-form.tsx:198`
*zone: routes-config · effort: quick-win · confidence: 0.6 · status: pending*
...
### 28. [MEDIUM/correctness] `routes/inventory-management/spot-check/_components/sc-entry-component.tsx:146`
*zone: routes-inventory · effort: quick-win · confidence: 0.5 · status: pending*
...
### 29. [MEDIUM/correctness] `routes/inventory-management/inventory-adjustment/_components/ia-item-table.tsx:86`
*zone: routes-inventory · effort: medium · confidence: 0.45 · status: pending*
...
### 30. [MEDIUM/correctness] `routes/operation-plan/recipe/_components/recipe-form-schema.ts:197`
*zone: routes-operation-plan · effort: quick-win · confidence: 0.65 · status: pending*
...
### 31. [MEDIUM/correctness] `routes/procurement/purchase-order/from-price-list/_components/step-select-items.tsx:117`
*zone: routes-procurement-a · effort: medium · confidence: 0.55 · status: pending*
...
### 32. [MEDIUM/correctness] `routes/procurement/purchase-order/_components/use-po-form-handlers.ts:164`
*zone: routes-procurement-a · effort: medium · confidence: 0.5 · status: pending*
...
### 33. [MEDIUM/correctness] `routes/procurement/purchase-request-template/_components/prt-item-table.tsx:42`
*zone: routes-procurement-b · effort: quick-win · confidence: 0.6 · status: pending*
...
### 34. [MEDIUM/correctness] `routes/procurement/goods-receive-note/_components/grn-product-cards.tsx:102`
*zone: routes-procurement-b · effort: quick-win · confidence: 0.55 · status: pending*
...
### 35. [MEDIUM/correctness] `routes/procurement/credit-note/_components/cn-form.tsx:92`
*zone: routes-procurement-b · effort: medium · confidence: 0.5 · status: pending*
...
### 36. [MEDIUM/correctness] `routes/procurement/credit-note/_components/cn-component.tsx:459`
*zone: routes-procurement-b · effort: medium · confidence: 0.65 · status: pending*
...
### 37. [MEDIUM/correctness] `routes/procurement/purchase-request-template/_components/prt-component.tsx:348`
*zone: routes-procurement-b · effort: medium · confidence: 0.6 · status: pending*
...
### 38. [MEDIUM/correctness] `routes/product-management/product/_components/pd-component.tsx:89`
*zone: routes-product · effort: quick-win · confidence: 0.85 · status: pending*
...
### 39. [MEDIUM/correctness] `routes/product-management/product/_components/pd-component.tsx:270`
*zone: routes-product · effort: medium · confidence: 0.8 · status: pending*
...
### 40. [MEDIUM/correctness] `routes/report/list/_components/report-param-dialog.tsx:149`
*zone: routes-report · effort: quick-win · confidence: 0.7 · status: pending*
...
### 41. [MEDIUM/correctness] `routes/external/pl/_components/price-list-external-product-table.tsx:138`
*zone: routes-report · effort: medium · confidence: 0.45 · status: pending*
...
### 42. [MEDIUM/perf] `routes/store-operation/store-requisition/_components/sr-component.tsx:128`
*zone: routes-store-operation · effort: quick-win · confidence: 0.9 · status: pending*
...
### 43. [MEDIUM/correctness] `routes/store-operation/store-requisition/_components/sr-component.tsx:138`
*zone: routes-store-operation · effort: medium · confidence: 0.7 · status: pending*
...
### 44. [MEDIUM/correctness] `hooks/use-wastage-report.ts:11`
*zone: routes-store-operation · effort: large · confidence: 0.95 · status: pending*
...
### 45. [MEDIUM/correctness] `routes/store-operation/stock-replenishment/_components/stock-repl-component.tsx:145`
*zone: routes-store-operation · effort: large · confidence: 0.9 · status: pending*
...
### 46. [MEDIUM/correctness] `routes/system-admin/workflow/_components/wf-routing.tsx:245`
*zone: routes-system-admin · effort: quick-win · confidence: 0.95 · status: pending*
...
### 47. [MEDIUM/correctness] `routes/system-admin/role/_components/role-component.tsx:67`
*zone: routes-system-admin · effort: medium · confidence: 0.75 · status: pending*
...
### 48. [MEDIUM/correctness] `routes/system-admin/workflow/[id]/_content.tsx:11`
*zone: routes-system-admin · effort: quick-win · confidence: 0.5 · status: pending*
...
### 49. [MEDIUM/correctness] `routes/vendor-management/vendor/_components/vendor-form.tsx:207`
*zone: routes-vendor · effort: medium · confidence: 0.6 · status: pending*
...
### 50. [MEDIUM/correctness] `routes/vendor-management/price-list/_components/pl-form.tsx:151`
*zone: routes-vendor · effort: medium · confidence: 0.55 · status: pending*
...
### 51. [MEDIUM/correctness] `routes/vendor-management/price-list-template/_components/use-plt-form-actions.ts:62`
*zone: routes-vendor · effort: large · confidence: 0.5 · status: pending*
...
### 52. [MEDIUM/correctness] `routes/vendor-management/price-list-template/_components/plt-product-table.tsx:222`
*zone: routes-vendor · effort: medium · confidence: 0.5 · status: pending*
...
### 53. [MEDIUM/correctness] `types/product.ts:137`
*zone: types-utils · effort: quick-win · confidence: 0.85 · status: pending*
...
### 54. [MEDIUM/security] `constant/api-endpoints.ts:188`
*zone: types-utils · effort: quick-win · confidence: 0.7 · status: pending*
...
## Backlog (large effort — not fixed in this pass)

- `hooks/use-wastage-report.ts:11` — The entire wastage-reporting module (routes/store-operation/wastage-reporting list, [id] and new pages) is backed by mock data (`wrMockData` from routes/store-o
- `routes/store-operation/stock-replenishment/_components/stock-repl-component.tsx:145` — `handleCreatePR` and `handleCreateSR` are no-ops: they call `getSelectedProducts()` and discard the result. The 'Create PR (n)' / 'Create SR (n)' buttons shown 
- `routes/vendor-management/price-list-template/_components/use-plt-form-actions.ts:62` — Template edit only ever sends products: { add: <entire flattened list> } when details are dirty, and sends products: {} when the user has removed every product 

## Rejected by verification

Findings the reviewers raised but ≥2 skeptics refuted — recorded for the audit trail.
...
- **routes-dashboard** (routes/dashboard, routes/profile, routes/notifications) — the workflow reviewer died on API Overloaded, then the resume hit the monthly spend limit. Reviewed by hand instead. No confirmed bugs. Minor notes: (1) `dashboard-component.tsx` optimistic widget reorder updates the query cache but does not roll back if a per-widget PATCH fails (self-corrects on next refetch); (2) `inferWidgetTypeFromShape` declares a `"bar"` return that is never produced; (3) `change-password-dialog.tsx` `new_password` input is missing the `disabled={isPending}` the other two password fields have.
