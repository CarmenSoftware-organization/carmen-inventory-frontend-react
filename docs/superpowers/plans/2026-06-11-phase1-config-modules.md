...
- [ ] **Step 3: Smoke-test against a real source page (on a scratch copy)**
...
- [ ] **Step 3: Implement `routes/module-error-boundary-adapter.tsx`**
...
- [ ] **Step 4: Run tests** — Expected: PASS. Full gates: `bunx tsc --noEmit`, `bun run lint`, `bun run test:run` all clean.
...
- [ ] **Step 3: Register the config parent route**
...
- [ ] **Step 5: Authenticated browser probe (manual smoke)**
...
- [ ] **Step 1: Copy + codemod in one loop**
...
- [ ] **Step 2: Hand-convert the two `[id]/page.tsx`**
...
- [ ] **Step 5: Authenticated probe — page-based flow**
...
- [ ] **Step 1: Extend `playwright.config.ts` with a gated project + dev webServer**
...
- [ ] **Step 2: Write `e2e/authenticated-config.spec.ts`**
