...
// FormToolbar → useCan() → useLicense() reads runtime config (LICENSE_ENFORCEMENT
// switch) — without this it throws "Runtime config not loaded" on every render.
// enforced defaults to false here (shadow mode), matching this test's intent:
// it only cares about the account_code field, not license behavior.
beforeEach(() => {
