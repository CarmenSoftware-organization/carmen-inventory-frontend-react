...
function Host({
  ...
  return <PdTabGeneral form={form} isDisabled={isDisabled} product={product} />;
}
...
describe("PdTabGeneral — auto-generated code field", () => {
...
describe("PdTabGeneral — category cascade", () => {
