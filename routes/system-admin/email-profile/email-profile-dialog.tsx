 ...
 * รหัสผ่านจริงเสมอ ห้ามส่ง mask กลับไป ไม่งั้น backend throw — รวม logic ประกอบ array ไว้
 * จุดเดียวยังดีกว่าแยกไว้สองที่ แม้ตอนนี้ไม่ใช่เรื่องลำดับแล้วก็ตาม
 *
