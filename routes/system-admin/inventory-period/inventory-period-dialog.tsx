...
/**
 * Dialog สำหรับเพิ่ม/แก้ไขรอบสินค้าคงคลัง (InventoryPeriod) พร้อมตรวจสอบข้อมูลด้วย Zod schema
 * @param props - สถานะ open, callback onOpenChange และข้อมูล period (ถ้าเป็นโหมดแก้ไข)
 * @returns React element ของ Dialog
 * @example
 * <InventoryPeriodDialog open={open} onOpenChange={setOpen} period={editInventoryPeriod} />
 */
