...
export default function PrSelectTemplate({ template, onSelect }: Props) {
  ...
  return (
    <button
      ...
      className="group bg-card hover:border-primary/40 focus-visible:ring-primary/40 relative flex w-full min-w-0 items-start gap-3 overflow-hidden rounded-xl border p-3 text-left transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md focus:outline-none focus-visible:ring-2"
    >
