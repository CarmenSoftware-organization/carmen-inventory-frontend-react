...
/**
 * ช่องกรอกส่วนลดกับภาษีของรายการ — ก้อนเดียว ใช้ทั้งหน้าเดิมและ v2
 *
 * เดิมเขียนฝังอยู่ใน `pr-item-expand.tsx` ก้อนใหญ่ v2 จึงต้องเขียนเวอร์ชันของตัวเอง
 * แล้วสองที่ก็เริ่มไม่เหมือนกัน (ปุ่ม clamp, ตัวคั่น, กฎว่าช่องไหน disabled เมื่อ
 * override เปิด/ปิด) แยกออกมาที่เดียวเพื่อให้แก้ครั้งเดียวได้ทั้งสองหน้า
 *
