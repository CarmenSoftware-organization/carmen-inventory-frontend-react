 ...
 *
 * v2 ไม่มีแถวกาง ทั้ง 5 ตัวเป็นคอลัมน์จริงหมดแล้ว ตัวนี้จึงเหลือหน้าที่เดียว:
 * **ยอดสกุลหลัก** ซึ่งไม่ได้เป็นคอลัมน์ (จะกลายเป็น 10 คอลัมน์ตัวเลขติดกัน) แต่ก็
 * ตัดทิ้งไม่ได้ เพราะใบที่ซื้อหลายสกุลจะเทียบราคากันไม่ได้เลยถ้าไม่มี
 *
 * คงบรรทัดสกุลรายการไว้ในตารางนี้ด้วยแม้จะซ้ำกับคอลัมน์ — วางคู่กันถึงจะเทียบได้
 */
