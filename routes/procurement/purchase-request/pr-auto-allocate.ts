 ...
 *
 * หน้าเดิม (v1) sync ยอดใน `pr-item-expand` ซึ่ง mount เฉพาะตอนกางแถว — แถวที่
 * หุบอยู่จึงต้องคำนวณตรงนี้เอง · หน้า v2 มี `usePr2AmountSync` ผูกกับทุกแถวอยู่แล้ว
 * เรียกซ้ำก็ได้ผลเท่าเดิม (idempotent)
 */
 ...
 *
 * อยู่ในไฟล์กลางเพราะทั้งหน้าเดิมและ v2 ต้องได้ผลเหมือนกันเป๊ะ — ตรรกะว่าจะเลือก
 * ราคาไหน/เคลียร์ field อะไรเมื่อไม่เจอราคา ห้ามแตกเป็นสองชุด
 *
