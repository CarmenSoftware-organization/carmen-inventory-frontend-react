  ...
  purchase_order_detail: [
    {
      ...
      order_unit: { id: "unit-kg", name: "KG" },
      order_unit_conversion_factor: 1,
      order_qty: 23,
      base_unit: { id: "unit-kg", name: "KG" },
      base_qty: 23,
      price: 56,
      ...
      info: {},
      // แถวหนึ่ง = คลังเดียว
      location: { id: "loc-direct", code: "2FO03", name: "Rooms-Front Office - Direct" },
      delivery_point: { id: "dp-1", name: "Main Store" },
      // ยอดที่รับแล้วอยู่ในนี้ ไม่ได้อยู่บนแถว — pr_detail เป็น object (id-only) ตาม
      // contract ใหม่ ส่วนฟอร์มยังเก็บ pr_detail_id แบบ flat (ดู PrDetailRefPayload)
      pr_details: [
        {
          pr_detail: { id: "pr-detail-1" },
          order_qty: 20,
          order_base_qty: 20,
          received_qty: 8,
          foc_qty: 0,
